...
(function() {
  ...
  Morris.Donut = (function(_super) {
    ...
    Donut.prototype.redraw = function() {
      ...
      this.text1 = this.drawEmptyDonutLabel(cx, cy - 10, this.options.labelColor, '18px', 800);
      this.text2 = this.drawEmptyDonutLabel(cx, cy + 10, this.options.labelColor, '13px');
    ...
    Donut.prototype.setLabels = function(label2, label1) {
      var inner, maxHeightBottom, maxHeightTop, maxWidth, text1bbox, text1scale, text2bbox, text2scale;
      inner = (Math.min(this.el.width() / 2, this.el.height() / 2) - 10) * 2 / 3;
      maxWidth = 1.8 * inner;
      maxHeightTop = inner;
      maxHeightBottom = inner;
      this.text1.attr({
        text: label1,
        transform: ''
      });
